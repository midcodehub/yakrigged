...
export default function AboutPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-24 pb-24">
      {/* Hero Section */}
      <section className="relative overflow-hidden rounded-3xl bg-brand-900 px-6 py-20 text-center text-white shadow-lg sm:px-12 sm:py-32">
        <svg
          aria-hidden
          ...
          strokeWidth="1.5"
        >
          <path d="M-40 110 C 240 70 460 160 700 110 S 1100 60 1320 125" />
          <path d="M-40 200 C 250 165 450 250 690 200 S 1110 150 1320 215" />
          <path d="M-40 300 C 240 265 460 350 700 298 S 1100 248 1320 315" />
          <path d="M-40 400 C 250 365 450 450 690 398 S 1110 348 1320 415" />
        </svg>
        <div
          aria-hidden
          className="pointer-events-none absolute -bottom-16 -left-16 h-80 w-80 rounded-full bg-accent-500/15 blur-3xl"
        />
        <div className="relative mx-auto max-w-3xl">
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.22em] text-brand-200">
      ...
      <section>
        ...
        <div className="grid gap-8 sm:grid-cols-3">
          {/* Rule 1 */}
          <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-sand-200 transition-shadow hover:shadow-md">
            ...
            <h3 className="mb-3 text-xl font-semibold text-ink-900">The 10-Hour Rule</h3>
          ...
          <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-sand-200 transition-shadow hover:shadow-md">
            ...
            <h3 className="mb-3 text-xl font-semibold text-ink-900">Real Measurements</h3>
            <p className="text-ink-600">
          ...
          <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-sand-200 transition-shadow hover:shadow-md">
            ...
            <h3 className="mb-3 text-xl font-semibold text-ink-900">100% Transparent</h3>
            <p className="text-ink-600">
      ...
      {/* Meet the Team */}
      <section className="rounded-3xl bg-sand-100 px-6 py-16 sm:px-12">
        <div className="mb-12 text-center sm:text-left">
          <h2 className="text-3xl font-semibold tracking-tight text-ink-900">Who We Are</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {authors.map((author) => (
            <div key={author.name} className="flex flex-col gap-6 sm:flex-row sm:items-start rounded-2xl bg-white p-6 shadow-sm ring-1 ring-sand-200">
              <div className="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-full bg-brand-100 font-semibold text-brand-700 sm:h-20 sm:w-20">
                {author.avatar ? (
              ...
              <div>
                <h3 className="text-xl font-semibold text-ink-900">
                  <Link href={`/authors/${authorToSlug(author.name)}`} className="hover:text-brand-700 hover:underline">
                    {author.name}
                  </Link>
                </h3>
                <p className="mb-3 mt-1 text-sm font-semibold text-brand-700">{author.title}</p>
      ...
      {/* CTA / Contact Section */}
      <section className="text-center rounded-3xl bg-white px-6 py-16 ring-1 ring-sand-200 sm:px-12">
        <h2 className="text-3xl font-semibold tracking-tight text-ink-900">Get in Touch</h2>
